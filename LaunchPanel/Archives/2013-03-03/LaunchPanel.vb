Imports System.Runtime.InteropServices, System.Speech
...
Public Class LaunchPanel
    ...
    Private Sub LaunchPanel_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        Dim synthList As New Recognition.SrgsGrammar.SrgsOneOf("open launchpanel", "close launchpanel", "kill launchpanel", "launch google chrome", "open google chrome", "new chrome window", "switch window")
